...
('S56', 'Bravia 55', 'Alta tele', 2, 3, 'https://intercompras.com/product_thumb_keepratio_2.php?img=images/product/SONY_KDL-55W950A.jpg&w=650&h=450', 49500),
('A23', 'Apple TV', 'lindo loro', 3, 2, 'https://cnnespanol2.files.wordpress.com/2015/12/gadgets-mc3a1s-populares-apple-tv-2015-18.jpg?quality=100&strip=info&w=460&h=260&crop=1', 7850)

select * from ARTICULOS
select * from MARCAS
select * from CATEGORIAS

Select Codigo, IdCategoria, IdMarca, A.Descripcion Descripcion, Precio, 
Nombre, ImagenUrl, M.Descripcion Marca, C.Descripcion Categoria 
